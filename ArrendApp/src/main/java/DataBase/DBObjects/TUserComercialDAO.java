...
//  */
// public class TUserComercialDAO {
    // public static final String SQLCHECK_ALL = "SELECT ub.ID as buildingID, ub.levels, ub.rooms, ub.bathrooms, ub.score, ub.equiped, ub.hasCook, ub.includedServices, ub.available,"
...
//     public static final String SQLCHECK_ID = "SELECT uc.ID as comercialID, uu.name, uu.lastName, uu.phoneNumber, uu.email "
//             + "FROM DB_UserUsers uu, DB_UserComercial uc "
//             + "WHERE uu.ID = uc.ID AND uc.ID = (?) AND v.status";
...
//             ps = con.prepareStatement(SQLCHECK_ALL);
...
//                 int id = resultado.getInt("comercialID");
//                 String telefono = resultado.getString("phoneNumber");
//                 String correo = resultado.getString("email");
//                 User_Comercial landlord = new User_Comercial(id, nombre, apellido, telefono, correo, null, null);
...
//                 Building building = new Building(buildingId, landlord, direction, levels, rooms, bathrooms, score,
//                         equiped, hasCook, includedServices, available, service);
